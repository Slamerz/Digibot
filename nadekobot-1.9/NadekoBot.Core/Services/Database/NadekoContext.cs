...
using CurrencyTransaction = NadekoBot.Core.Services.Database.Models.CurrencyTransaction;
using Digimon = NadekoBot.Core.Modules.Digimon.Digimon;
...
namespace NadekoBot.Core.Services.Database
{
    ...
    public class NadekoContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var digimonEntity = modelBuilder.Entity<Digimons>();
            digimonEntity
                .HasIndex(c => c.Id);
